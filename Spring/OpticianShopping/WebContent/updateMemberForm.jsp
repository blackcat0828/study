...
-->
	...
	<div class="container">
		<form name="newMember"
			  action="updateMember.member" 
			  method="post" onsubmit="return checkForm()">
			<div class="form-group  row">
				<label for="id" class="col-sm-2 ">아이디</label>
				<div class="col-sm-3">
					<input name="id" id="id" type="text" class="form-control" placeholder="아이디입력" value="${member.id }" readonly="readonly">
				</div>
			</div>
			<div class="form-group  row">
				<label class="col-sm-2">비밀번호</label>
				<div class="col-sm-3">
					<input name="password" type="text" class="form-control" placeholder="비밀번호 입력" value="${member.password }">
				</div>
			</div>
			<div class="form-group  row">
				<label class="col-sm-2">비밀번호확인</label>
				<div class="col-sm-3">
					<input name="password_confirm" type="text" class="form-control" placeholder="비밀번호 확인 입력" value="${member.password }">
				</div>
			</div>
			<div class="form-group  row">
				<label class="col-sm-2">이름</label>
				<div class="col-sm-3">
					<input name="name" type="text" class="form-control" placeholder="이름 입력" value="${member.name }">
				</div>
			</div>
			...
			<div class="form-group  row">
				...
				<div class="col-sm-3">
					<input class="contact" name="contact" type="text" class="form-control" value="${member.contact }" >
			...
			<div class="form-group row">
				...
				<div class="col-sm-5">
					<input id="addressName" name="addr" type="text" readonly="readonly"
					       class="form-control" value="${member.addr }"/>
